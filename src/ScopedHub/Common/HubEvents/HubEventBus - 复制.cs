...
//namespace ScopedHub.Common.HubEvents
//{
...
//    //public interface IHubContextEvent<THub> : IHubEvent where THub : Hub
//    //{
//    //    IHubContext<THub> RaiseHubContext { get; set; } 
//    //}

//    //public abstract class BaseOutsideHubEvent<THub> : IHubContextEvent<THub> where THub : Hub
//    //{
//    //    //只有在Hub内触发的事件，raiseHub才会被赋值
//    //    protected BaseOutsideHubEvent(IHubContext<THub> hubContext)
//    //    {
//    //        RaiseHubContext = hubContext;
//    //        RaiseAt = DateHelper.Instance.GetDateNow();
//    //    }
//    //    public DateTime RaiseAt { get; private set; }
//    //    public Hub RaiseHub { get; set; }
//    //    public IHubContext<THub> RaiseHubContext { get; set; }
//    //}
...
//    //{
//    //    //只有在Hub内触发的事件，raiseHub才会被赋值
//    //    protected BaseHubEvent(ScopedConnection context, Hub raiseHub = null)
//    //    {
//    //        Context = context;
//    //        RaiseAt = DateHelper.Instance.GetDateNow();
//    //        RaiseHub = raiseHub;
//    //    }
//    //    public ScopedConnection Context { get; set; }
//    //    public DateTime RaiseAt { get; private set; }
//    //    public Hub RaiseHub { get; set; }
//    //}
